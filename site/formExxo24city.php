...
<body>
    <div class="image-container">
        ...
        <form action="../site/inserirExxo24city.php" method="post">
            <!-- Campos de entrada -->
            ...
            <div class="checkbox-container">
                ...
                <label for="termos" class="terms-label" style="font-size: 13px;">
                    EU ACEITO OS TERMOS 
                    <a href="../Exxos/DOC/EXXO 01 _ TERMO DE USO DO APLICATIVO _ WEBSITE EXXO (1).pdf" target="_blank" style="font-size: 13px;">GERAIS DE USO DA EXXOS</a>
                </label>
            </div>
